...
// ISSUE-40-DESIGN.md §5: an unmeasured path in a security-relevant list is a
...
// owner-gating was considered and rejected (ISSUE-40-DESIGN.md §6 reason 2:
...
// keys from the host's file, not implemented here (ISSUE-40-DESIGN.md §5).
...
// is the WHEN — decided in ISSUE-40-DESIGN.md §1, restated here because the
